...
#   PSIAHRS -> AHRS Noise With IMU[0] (Psi)
#   RAHRS -> AHRS Noise With IMU[1] (R)
#   PSIIMU -> Measure Noise Covariance[4] (Psi IMU)
#   RIMU -> Measure Noise Covariance[5] (R IMU)
...
# USER INPUTS:
#   Branch
branch='feature/NavTest_scripts'

#   General variables:
logs=(  '115150_navigation_test_fig8'
        '133742_navigation_test_fig8'
        '151817_navigation_test_fig8'
        '160624_navigation_test_fig8')
...
PSIAHRS=('1e-2' '1e-4' '1e-6')
RAHRS=('1e-2' '1e-4' '1e-6')
PSIIMU=('1e-6' '1e-4' '1e-2')
RIMU=('1e-6' '1e-4' '1e-2')
...
for ((l=0; l<${#logs[@]}; l++)); do
    for ((n=0; n<${#PSIAHRS[@]}; n++)); do
        ...
        COMMANDS+="s+\#PSIAHRS\#+${PSIAHRS[$n]}+g;"
        COMMANDS+="s+\#RAHRS\#+${RAHRS[$n]}+g;"
        COMMANDS+="s+\#PSIIMU\#+${PSIIMU[$n]}+g;"
        COMMANDS+="s+\#RIMU\#+${RIMU[$n]}+g;"
