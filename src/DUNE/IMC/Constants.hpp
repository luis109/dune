...
#define DUNE_IMC_CONST_GIT_INFO "2023-05-16 d7cf94f  (HEAD -> greenhouse-master, luis109/greenhouse-master)"
//! MD5 sum of XML specification file.
#define DUNE_IMC_CONST_MD5 "940c845def4491a3e2c46b5656c7d41a"
