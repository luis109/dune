...
namespace DUNE
{
  namespace IMC
  {
    ...
    bool
    PlantState::fieldsEqual(const Message& msg__) const
    {
      const IMC::PlantState& other__ = static_cast<const PlantState&>(msg__);
      if (stage != other__.stage) return false;
      if (days_elapsed != other__.days_elapsed) return false;
      return true;
    }

    int
    PlantState::validate(void) const
    {
      return true;
    }

    uint8_t*
    PlantState::serializeFields(uint8_t* bfr__) const
    {
      uint8_t* ptr__ = bfr__;
      ptr__ += IMC::serialize(stage, ptr__);
      ptr__ += IMC::serialize(days_elapsed, ptr__);
      return ptr__;
    }

    uint16_t
    PlantState::deserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::deserialize(stage, bfr__, size__);
      bfr__ += IMC::deserialize(days_elapsed, bfr__, size__);
      return bfr__ - start__;
    }

    uint16_t
    PlantState::reverseDeserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::deserialize(stage, bfr__, size__);
      bfr__ += IMC::reverseDeserialize(days_elapsed, bfr__, size__);
      return bfr__ - start__;
    }

    void
    PlantState::fieldsToJSON(std::ostream& os__, unsigned nindent__) const
    {
      IMC::toJSON(os__, "stage", stage, nindent__);
      IMC::toJSON(os__, "days_elapsed", days_elapsed, nindent__);
    }

    DesiredLight::DesiredLight(void)
    {
      m_header.mgid = 3001;
      clear();
    }
    ...
    void
    DesiredLight::clear(void)
    {
      value = 0;
    }

    bool
    DesiredLight::fieldsEqual(const Message& msg__) const
    {
      const IMC::DesiredLight& other__ = static_cast<const DesiredLight&>(msg__);
      if (value != other__.value) return false;
      return true;
    }

    int
    DesiredLight::validate(void) const
    {
    ...
    uint8_t*
    DesiredLight::serializeFields(uint8_t* bfr__) const
    {
      uint8_t* ptr__ = bfr__;
      ptr__ += IMC::serialize(value, ptr__);
      return ptr__;
    ...
    uint16_t
    DesiredLight::deserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::deserialize(value, bfr__, size__);
      return bfr__ - start__;
    ...
    uint16_t
    DesiredLight::reverseDeserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::reverseDeserialize(value, bfr__, size__);
      return bfr__ - start__;
    ...
    fp64_t
    DesiredLight::getValueFP(void) const
    {
      return static_cast<fp64_t>(value);
    }

    void
    DesiredLight::setValueFP(fp64_t val)
    {
      value = static_cast<fp32_t>(val);
    }

    void
    DesiredLight::fieldsToJSON(std::ostream& os__, unsigned nindent__) const
    {
      IMC::toJSON(os__, "value", value, nindent__);
    }

    DesiredAirFlow::DesiredAirFlow(void)
    {
      m_header.mgid = 3002;
      clear();
    }
    ...
    void
    DesiredAirFlow::clear(void)
    {
      value = 0;
    }

    bool
    DesiredAirFlow::fieldsEqual(const Message& msg__) const
    {
      const IMC::DesiredAirFlow& other__ = static_cast<const DesiredAirFlow&>(msg__);
      if (value != other__.value) return false;
      return true;
    }

    int
    DesiredAirFlow::validate(void) const
    {
      if (value < 0 || value > 1) return false;
      return true;
    }
    ...
    uint8_t*
    DesiredAirFlow::serializeFields(uint8_t* bfr__) const
    {
      uint8_t* ptr__ = bfr__;
      ptr__ += IMC::serialize(value, ptr__);
      return ptr__;
    ...
    uint16_t
    DesiredAirFlow::deserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::deserialize(value, bfr__, size__);
      return bfr__ - start__;
    ...
    uint16_t
    DesiredAirFlow::reverseDeserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::reverseDeserialize(value, bfr__, size__);
      return bfr__ - start__;
    ...
    fp64_t
    DesiredAirFlow::getValueFP(void) const
    {
      return static_cast<fp64_t>(value);
    }

    void
    DesiredAirFlow::setValueFP(fp64_t val)
    {
      value = static_cast<fp32_t>(val);
    }

    void
    DesiredAirFlow::fieldsToJSON(std::ostream& os__, unsigned nindent__) const
    {
      IMC::toJSON(os__, "value", value, nindent__);
    }

    DesiredIrrigation::DesiredIrrigation(void)
    {
      m_header.mgid = 3003;
      clear();
    }
    ...
    void
    DesiredIrrigation::clear(void)
    {
      value = 0;
    }

    bool
    DesiredIrrigation::fieldsEqual(const Message& msg__) const
    {
      const IMC::DesiredIrrigation& other__ = static_cast<const DesiredIrrigation&>(msg__);
      if (value != other__.value) return false;
      return true;
    }

    int
    DesiredIrrigation::validate(void) const
    {
      if (value < 0 || value > 1) return false;
      return true;
    }
    ...
    uint8_t*
    DesiredIrrigation::serializeFields(uint8_t* bfr__) const
    {
      uint8_t* ptr__ = bfr__;
      ptr__ += IMC::serialize(value, ptr__);
      return ptr__;
    ...
    uint16_t
    DesiredIrrigation::deserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::deserialize(value, bfr__, size__);
      return bfr__ - start__;
    ...
    uint16_t
    DesiredIrrigation::reverseDeserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::reverseDeserialize(value, bfr__, size__);
      return bfr__ - start__;
    ...
    fp64_t
    DesiredIrrigation::getValueFP(void) const
    {
      return static_cast<fp64_t>(value);
    }

    void
    DesiredIrrigation::setValueFP(fp64_t val)
    {
      value = static_cast<fp32_t>(val);
    }

    void
    DesiredIrrigation::fieldsToJSON(std::ostream& os__, unsigned nindent__) const
    {
      IMC::toJSON(os__, "value", value, nindent__);
    }

    DesiredTemperature::DesiredTemperature(void)
    {
      m_header.mgid = 3004;
      clear();
    }
    ...
    void
    DesiredTemperature::clear(void)
    {
      value = 0;
    }

    bool
    DesiredTemperature::fieldsEqual(const Message& msg__) const
    {
      const IMC::DesiredTemperature& other__ = static_cast<const DesiredTemperature&>(msg__);
      if (value != other__.value) return false;
      return true;
    }

    int
    DesiredTemperature::validate(void) const
    {
      return true;
    }

    uint8_t*
    DesiredTemperature::serializeFields(uint8_t* bfr__) const
    {
      uint8_t* ptr__ = bfr__;
      ptr__ += IMC::serialize(value, ptr__);
      return ptr__;
    ...
    uint16_t
    DesiredTemperature::deserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::deserialize(value, bfr__, size__);
      return bfr__ - start__;
    ...
    uint16_t
    DesiredTemperature::reverseDeserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::reverseDeserialize(value, bfr__, size__);
      return bfr__ - start__;
    ...
    fp64_t
    DesiredTemperature::getValueFP(void) const
    {
      return static_cast<fp64_t>(value);
    }

    void
    DesiredTemperature::setValueFP(fp64_t val)
    {
      value = static_cast<fp32_t>(val);
    }

    void
    DesiredTemperature::fieldsToJSON(std::ostream& os__, unsigned nindent__) const
    {
      IMC::toJSON(os__, "value", value, nindent__);
    }
  }
