...
//! PlantState identification number.
#define DUNE_IMC_PLANTSTATE 3000
//! DesiredLight identification number.
#define DUNE_IMC_DESIREDLIGHT 3001
//! DesiredAirFlow identification number.
#define DUNE_IMC_DESIREDAIRFLOW 3002
//! DesiredIrrigation identification number.
#define DUNE_IMC_DESIREDIRRIGATION 3003
//! DesiredTemperature identification number.
#define DUNE_IMC_DESIREDTEMPERATURE 3004
