...
namespace DUNE
{
  namespace IMC
  {
    ...
    //! Plant State.
    class PlantState: public Message
    {
    public:
      //! Plant Stage.
      enum PlantStageEnum
    ...
    //! Desired Light.
    class DesiredLight: public Message
    {
    public:
      //! Light Level.
      fp32_t value;
      ...
      getId(void) const
      {
        return DesiredLight::getIdStatic();
      }
    ...
    //! Desired Air Flow.
    class DesiredAirFlow: public Message
    {
    public:
      //! Air Flow Level.
      fp32_t value;
      ...
      clone(void) const
      {
        return new DesiredAirFlow(*this);
      }
      ...
      getId(void) const
      {
        return DesiredAirFlow::getIdStatic();
      }
    ...
    //! Desired Irrigation.
    class DesiredIrrigation: public Message
    {
    public:
      //! Irrigation Level.
      fp32_t value;
      ...
      DesiredIrrigation(void);

      DesiredIrrigation*
      clone(void) const
      {
        return new DesiredIrrigation(*this);
      }
      ...
      getId(void) const
      {
        return DesiredIrrigation::getIdStatic();
      }

      const char*
      getName(void) const
      {
        return "DesiredIrrigation";
      }
    ...
    //! Desired Temperature.
    class DesiredTemperature: public Message
    {
    public:
      //! Desired Temperature.
      fp32_t value;
      ...
      DesiredTemperature(void);

      DesiredTemperature*
      clone(void) const
      {
        return new DesiredTemperature(*this);
      }
      ...
      getId(void) const
      {
        return DesiredTemperature::getIdStatic();
      }
